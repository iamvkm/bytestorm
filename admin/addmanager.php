...
if (isset($_POST['submit'])) {
     ...
     $qry = "INSERT INTO manager " . "(name,email,username,password,phone)" . " VALUES "
          . "('$name','$email','$username','$password','$phone')";
     $run = mysqli_query($conn, $qry);

     if ($run == true) echo "
          <script>
          confirm('Manager Account Added! Redirecting to Dashboard.');
...
<head>
     <title>Add Manager Account - Subscriber Management System</title>
     ...
     <div class="container d-flex justify-content-center" style="text-align: center;">
          <div class="row">
               <div class="login-page">
                    <div class="form">
                         <form class="login-form" action="addmanager.php" method="post">
                              ...
                              <button type="submit" class="btn btn-primary" name="submit" value="Submit">
                                   Add Manager Account</button><br><br>
